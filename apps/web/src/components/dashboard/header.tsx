...
export function DashboardHeader({
  ...
  return (
    <header className="bg-ink-0/95 sticky top-0 z-30 border-b border-white/[0.06] backdrop-blur-sm">
      <div className="flex flex-wrap items-center gap-x-2 gap-y-2 px-3 py-2 sm:gap-x-3 sm:px-4">
        ...
        {/* No mobile este bloco quebra para uma segunda linha (order-last +
            w-full); no sm+ volta ao lugar original entre o spacer e o Novo. */}
        <div className="order-last flex w-full min-w-0 flex-col gap-2 sm:order-none sm:w-auto sm:flex-row sm:items-center sm:gap-3">
            ...
            {pills.map((p) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "focus-visible:ring-offset-ink-0 inline-flex h-7 shrink-0 items-center gap-1.5 rounded-md px-2.5 text-[12px] font-medium whitespace-nowrap transition-colors focus-visible:ring-2 focus-visible:ring-sky-400 focus-visible:ring-offset-2 focus-visible:outline-none",
                    active
          ...
          <label className="relative flex w-full items-center sm:w-auto">
            ...
            <input
              ...
              className="bg-ink-200 placeholder:text-zinc-500 focus:ring-sky-400 h-7 w-full rounded-md py-1 pr-12 pl-7 text-[12px] text-zinc-100 ring-1 ring-inset ring-white/10 focus:ring-2 focus:outline-none sm:w-44"
        ...
        <button
          ...
          className="bg-ink-200 hidden h-7 items-center gap-1.5 rounded-md px-2.5 text-[12px] font-medium text-zinc-300 opacity-50 ring-1 ring-inset ring-white/10 sm:inline-flex"
        >
        ...
        {currentUser.role === "admin" && (
          <Link
            ...
            className="bg-ink-200 inline-flex h-7 items-center gap-1.5 rounded-md px-2 text-[12px] font-medium text-zinc-300 ring-1 ring-inset ring-white/10 hover:text-zinc-50 sm:px-2.5"
          >
